...
$usuario = 'SELECT * FROM catespecialidad ORDER BY IDESPECIALIDAD DESC';
$usuarios = $mysqli->query($usuario);
...
<?php while ($user = $usuarios->fetch_assoc()) { ?>
                            ...
                            <tr class="<?php if ($user['IDESPECIALIDAD'] != 's') {
        echo 'active';
    } else {
        echo 'danger';
    } ?>">
                                <td><?php echo $user['IDESPECIALIDAD']; ?></td>
                                <td><?php echo $user['NOMBREESPECIALIDAD']; ?></td> 
                                <td><?php echo $user['IDMEDICO']; ?></td> 
                            </tr>
<?php } ?>
